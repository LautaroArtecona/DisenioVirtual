...
#define LOW_PRECISION`),e}function Y1(o){let e="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===Mv?e="SHADOWMAP_TYPE_PCF":o.shadowMapType===yS?e="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===ha&&(e="SHADOWMAP_TYPE_VSM"),e}function j1(o){let e="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Fr:case zr:e="ENVMAP_TYPE_CUBE";break;case fu:e="ENVMAP_TYPE_CUBE_UV";break}return e}function K1(o){let e="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case zr:e="ENVMAP_MODE_REFRACTION";break}return e}function Z1(o){let e="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case Ev:e="ENVMAP_BLENDING_MULTIPLY";break;case FS:e="ENVMAP_BLENDING_MIX";break;case zS:e="ENVMAP_BLENDING_ADD";break}return e}function Q1(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,a=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:a,maxMip:n}}function J1(o,e,n,a){const r=o.getContext(),c=n.defines;let u=n.vertexShader,h=n.fragmentShader;const p=Y1(n),d=j1(n),g=K1(n),_=Z1(n),v=Q1(n),y=z1(n),E=H1(c),T=r.createProgram();let S,x,N=n.glslVersion?"#version "+n.glslVersion+`
